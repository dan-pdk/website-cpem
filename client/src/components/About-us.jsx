...
function AboutUs() {
    return <div className="relative w-full bg-primary grid grid-cols-1 md:grid-cols-2 min-h-100 font-nunito-sans overflow-hidden">
        <div className="relative z-10 px-6 py-10 md:px-10 md:py-12 flex flex-col items-start gap-6 md:gap-8">
            <ScrollFadeIn>
                <h2 className="text-bg-100 text-5xl font-bold">
                  Quem nós{' '}
            ...
            <ScrollFadeIn>
                <p className="text-bg-100 text-sm md:text-base">Nossa missão é promover espaços de formação, troca de experiências, proposição de materiais e contribuição contínua para um ensino de matemática cada vez mais significativo.</p>
            </ScrollFadeIn>
